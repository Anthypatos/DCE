...
// USART0
static inline void USART0_enaInterrupt_RX() { SETBIT(UCSR1B, RXCIE1); }
static inline void USART0_disableInterrupt_RX() { CLEARBIT(UCSR1B, RXCIE1); }
static inline void USART0_enaInterrupt_TX() { SETBIT(UCSR1B, UDRIE1); }
static inline void USART0_disableInterrupt_TX() { CLEARBIT(UCSR1B, UDRIE1); }
...
// TIMER0
static inline void TMR0_CTC_EnaInterrupt() { SETBIT(TIMSK0, OCIE0A); }	// Enables interrupt on compare match
static inline void TMR0_CTC_DisInterrupt() { CLEARBIT(TIMSK0, OCIE0A); } // Disables interrupt on compare match
