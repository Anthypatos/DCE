...
#include "G:\OneDrive - uca.es\Docencia_actual\DCE\PROYECTOS_PRACTICAS\DCE_GIT\DCE_VARIOS\MACROS.h"
...
int main(void)
{
	...
	/** ------------ LOOP ----------------------------------------*/
	 while (1)	 
	 {
		...
		if ((button_CurrentState == BUTTON_PRESSED) && (flag == BUTTON_NOT_PRESSED))
		{	
			// Falling-edge
